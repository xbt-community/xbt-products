...
load Output.mat
tick_lat = 34:2:40;
label_lat = strcat(num2str(tick_lat'),'\circN');
...
exportgraphics(gcf, 'figure1_ax32.png', 'Resolution', 400);
%%
...
exportgraphics(gcf, 'figure2_ax32.png', 'Resolution', 400);
...
contourf(lat_ref,1:nt,dh0_ref',[-0.5:.1:1.8],'edgecolor','none'); hold on
...
set(ax,'ytick',-0.5:0.1:1.8,'yticklabel',-0.5:0.1:1.8)
set(ax,'colormap',clr_V2)
set(gca,'xcolor',xyclr,'ycolor',xyclr,'fontsize',10)
title(ax,'m','FontSize',10,'color',xyclr,'FontWeight','normal')
title('Surface Dynamic Height ')
%print -dpng -r400 figure3_ax32_abs.png
exportgraphics(gcf, 'figure3_ax32.png', 'Resolution', 400);
